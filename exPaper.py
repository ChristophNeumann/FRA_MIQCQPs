...
m.c2 = Constraint(expr = 3*m.i1**2 - m.i1*m.i2 + 2*m.i2**2 + 2.5*m.i2 <= 10 )
m.c3 = Constraint(expr = m.i1 + m.x <= 1000)
m.c4 = Constraint(expr = m.i1**2 + m.i1*m.x <= 3)

get_enlargement_nonlinear(m.c2)
get_enlargement_nonlinear(m.c4)