#  MINLP written by GAMS Convert at 01/04/19 10:31:28
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#         44       42        0        2        0        0        0        0
...
m.x3 = Var(within=Reals,bounds=(0,300),initialize=85.7142857142855)
m.x4 = Var(within=Reals,bounds=(0,300),initialize=57.1428571428572)
m.x5 = Var(within=Reals,bounds=(0,300),initialize=85.7142857142855)
m.x6 = Var(within=Reals,bounds=(0,300),initialize=24.2857142857143)
m.x7 = Var(within=Reals,bounds=(0,300),initialize=32.8571428571428)
m.x8 = Var(within=Reals,bounds=(0,300),initialize=57.142857142857)
m.x9 = Var(within=Reals,bounds=(0,300),initialize=28.5714285714285)
m.x10 = Var(within=Reals,bounds=(0,300),initialize=57.1428571428572)
m.x11 = Var(within=Reals,bounds=(0,300),initialize=0)
m.x12 = Var(within=Reals,bounds=(0,300),initialize=0)
m.x13 = Var(within=Reals,bounds=(0,300),initialize=24.2857142857143)
m.x14 = Var(within=Reals,bounds=(0,300),initialize=32.8571428571428)
...
m.x19 = Var(within=Reals,bounds=(0,300),initialize=28.5714285714285)
m.x20 = Var(within=Reals,bounds=(0,None),initialize=77.1428571428574)
m.x21 = Var(within=Reals,bounds=(0,None),initialize=137.142857142857)
m.x22 = Var(within=Reals,bounds=(0,100),initialize=28.5714285714286)
m.x23 = Var(within=Reals,bounds=(0,100),initialize=24.2857142857143)
m.x24 = Var(within=Reals,bounds=(0,100),initialize=4.28571428571429)
m.x25 = Var(within=Reals,bounds=(0,100),initialize=28.5714285714285)
m.x26 = Var(within=Reals,bounds=(0,100),initialize=28.5714285714285)
m.x27 = Var(within=Reals,bounds=(0,100),initialize=28.5714285714285)
m.x28 = Var(within=Reals,bounds=(0,1),initialize=0.5)
m.x29 = Var(within=Reals,bounds=(0,1),initialize=0.425)
m.x30 = Var(within=Reals,bounds=(0,1),initialize=0.075)
...
m.x34 = Var(within=Reals,bounds=(0,1),initialize=1)
m.x35 = Var(within=Reals,bounds=(0,1),initialize=0)
m.x36 = Var(within=Reals,bounds=(0,1),initialize=0)
m.x37 = Var(within=Reals,bounds=(0,1),initialize=0.130434782608696)
m.x38 = Var(within=Reals,bounds=(0,1),initialize=0.739130434782609)
m.x39 = Var(within=Reals,bounds=(0,1),initialize=0.130434782608694)
m.x40 = Var(within=Reals,bounds=(0,1),initialize=0.5)
m.x41 = Var(within=Reals,bounds=(0,1),initialize=0.425)
m.x42 = Var(within=Reals,bounds=(0,1),initialize=0.075)
m.x43 = Var(within=Reals,bounds=(0,1),initialize=0)
m.x44 = Var(within=Reals,bounds=(0,1),initialize=0.150000000000001)
m.x45 = Var(within=Reals,bounds=(0,1),initialize=0.85)
m.x46 = Var(within=Reals,bounds=(0.85,1),initialize=0.85)
m.x47 = Var(within=Reals,bounds=(0.85,1),initialize=1)
...
m.c23 = Constraint(expr=m.x12*m.x34 + m.x14*m.x37 + m.x16*m.x40 + m.x18*m.x43 + 0.333333333333333*m.x20 == 30)

m.c24 = Constraint(expr=m.x12*m.x35 + m.x14*m.x38 + m.x16*m.x41 + m.x18*m.x44 + 0.333333333333333*m.x20 == 50)

m.c25 = Constraint(expr=m.x12*m.x36 + m.x14*m.x39 + m.x16*m.x42 + m.x18*m.x45 + 0.333333333333333*m.x20 == 30)

m.c26 = Constraint(expr=m.x13*m.x34 + m.x15*m.x37 + m.x17*m.x40 + m.x19*m.x43 + 0.333333333333333*m.x21 == 70)

m.c27 = Constraint(expr=m.x13*m.x35 + m.x15*m.x38 + m.x17*m.x41 + m.x19*m.x44 + 0.333333333333333*m.x21 == 50)

m.c28 = Constraint(expr=m.x13*m.x36 + m.x15*m.x39 + m.x17*m.x42 + m.x19*m.x45 + 0.333333333333333*m.x21 == 70)
