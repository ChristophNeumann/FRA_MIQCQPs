#  MINLP written by GAMS Convert at 01/04/19 10:28:03
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#        481        0        1      480        0        0        0        0
...
m.c481 = Constraint(expr=m.b1 - 2*m.b1*m.b81 + 3*m.b81 - 2*m.b2*m.b56 + 2*m.b2*m.b86 + 4*m.b86 + 2*m.b3*m.b54 - 3*m.b54
                          + 2*m.b3*m.b56 - 2*m.b3*m.b83 + 4*m.b83 - 2*m.b3*m.b86 + 2*m.b4*m.b54 - 2*m.b4 + 2*m.b4*m.b56
                          + 2*m.b4*m.b71 - 4*m.b71 + 2*m.b4*m.b72 - 9*m.b72 - 2*m.b4*m.b84 + 3*m.b84 - 2*m.b4*m.b87 + 8*
                         m.b87 - 2*m.b5*m.b50 + m.b5 + 7*m.b50 + 2*m.b5*m.b60 + 3*m.b60 - 2*m.b5*m.b62 + 6*m.b62 + 2*
                         m.b5*m.b74 - 6*m.b74 - 2*m.b5*m.b90 + 6*m.b90 - 2*m.b6*m.b81 + 3*m.b6 - 2*m.b6*m.b83 - 2*m.b6*
                         m.b86 - 2*m.b7*m.b56 + m.b7 - 2*m.b7*m.b60 + 2*m.b7*m.b86 + 2*m.b8*m.b71 + 2*m.b8*m.b72 - 2*
                         m.b8*m.b83 - 2*m.b8*m.b86 - 2*m.b9*m.b50 + m.b9 - 2*m.b9*m.b60 + 2*m.b9*m.b74 + 2*m.b10*m.b54
                          - 2*m.b10 + 2*m.b10*m.b56 + 2*m.b11*m.b60 - m.b11 + 2*m.b12*m.b71 + m.b12 + 2*m.b12*m.b72 - 2*
                         m.b12*m.b81 - 2*m.b12*m.b83 - 2*m.b12*m.b86 - 2*m.b13*m.b50 + m.b13 - 2*m.b13*m.b56 - 2*m.b13*
                         m.b60 + 2*m.b13*m.b74 + 2*m.b13*m.b86 + 2*m.b14*m.b65 - 2*m.b14 - m.b65 + 2*m.b14*m.b66 - 4*
                         m.b66 + 2*m.b14*m.b71 + 2*m.b14*m.b72 - 2*m.b14*m.b84 - 2*m.b14*m.b87 - 2*m.b15*m.b47 + 2*m.b15
                          + 3*m.b47 - 2*m.b15*m.b50 - 2*m.b15*m.b62 + 2*m.b15*m.b68 - 4*m.b68 + 2*m.b15*m.b74 - 2*m.b15*
                         m.b90 - 2*m.b16*m.b84 + 2*m.b16 - 2*m.b16*m.b87 - 2*m.b17*m.b62 + 2*m.b17 - 2*m.b17*m.b90 + 2*
                         m.b18*m.b56 - m.b18 + 2*m.b18*m.b72 - 2*m.b18*m.b87 - 2*m.b19*m.b86 + m.b19 + 2*m.b20*m.b72 - 2
                         *m.b20*m.b86 + 2*m.b21*m.b56 - m.b21 + 2*m.b22*m.b72 - 2*m.b22*m.b86 + 2*m.b23*m.b66 - m.b23 + 
                         2*m.b23*m.b72 - 2*m.b23*m.b87 - 2*m.b24*m.b87 + m.b24 - 2*m.b25*m.b56 + 2*m.b25 - 2*m.b25*m.b60
                          - 2*m.b25*m.b72 - 2*m.b25*m.b74 + 2*m.b25*m.b87 + 2*m.b25*m.b90 - 2*m.b26*m.b50 + m.b26 - 2*
                         m.b26*m.b60 - 2*m.b26*m.b74 + 2*m.b26*m.b75 + 4*m.b75 + 2*m.b26*m.b90 + 2*m.b27*m.b50 - 2*m.b27
                          + 2*m.b27*m.b62 - 2*m.b28*m.b50 + 2*m.b28 - 2*m.b28*m.b56 - 2*m.b28*m.b60 - 2*m.b28*m.b72 - 2*
                         m.b28*m.b74 + 2*m.b28*m.b75 + 2*m.b28*m.b87 + 2*m.b28*m.b90 - 2*m.b29*m.b47 + m.b29 - 2*m.b29*
                         m.b50 - 2*m.b29*m.b62 + 2*m.b29*m.b63 - 3*m.b63 + 2*m.b29*m.b69 - 2*m.b30*m.b62 + 2*m.b30 - 2*
                         m.b30*m.b75 + 2*m.b31*m.b72 - m.b31 + 2*m.b31*m.b74 - 2*m.b31*m.b86 + 2*m.b32*m.b56 - 2*m.b32
                          + 2*m.b32*m.b60 + 2*m.b33*m.b72 - 2*m.b33 + 2*m.b33*m.b74 + 2*m.b34*m.b66 - 2*m.b34 + 2*m.b34*
                         m.b68 + 2*m.b34*m.b72 + 2*m.b34*m.b74 - 2*m.b34*m.b87 - 2*m.b34*m.b90 - 2*m.b35*m.b87 + 2*m.b35
                          - 2*m.b35*m.b90 + 2*m.b36*m.b50 - 2*m.b36 + 2*m.b36*m.b60 - 2*m.b37*m.b72 + 2*m.b37*m.b86 + 2*
                         m.b38*m.b63 - m.b38 + 2*m.b38*m.b68 + 2*m.b38*m.b74 - 2*m.b38*m.b75 - 2*m.b38*m.b90 - 2*m.b39*
                         m.b75 + 2*m.b39 - 2*m.b39*m.b90 - 2*m.b40*m.b50 + 3*m.b40 - 2*m.b40*m.b56 - 2*m.b40*m.b60 - 2*
                         m.b41*m.b47 + 3*m.b41 - 2*m.b41*m.b50 - 2*m.b41*m.b62 - 2*m.b42*m.b62 + m.b42 + 2*m.b43*m.b63
                          - 2*m.b43 + 2*m.b43*m.b66 + 2*m.b43*m.b68 + 2*m.b43*m.b72 + 2*m.b43*m.b74 - 2*m.b43*m.b75 - 2*
                         m.b43*m.b87 - 2*m.b43*m.b90 - 2*m.b44*m.b75 + 3*m.b44 - 2*m.b44*m.b87 - 2*m.b44*m.b90 - 2*m.b45
                         *m.b69 + 2*m.b45 - 2*m.b45*m.b75 + m.x91 >= 85)
