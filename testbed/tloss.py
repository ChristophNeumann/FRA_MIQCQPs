#  MINLP written by GAMS Convert at 01/04/19 10:37:15
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
#         54        1       13       40        0        0        0        0
...
m.i31 = Var(within=Integers,bounds=(0,5),initialize=0)
...
m.i44 = Var(within=Integers,bounds=(0,12),initialize=0)
...
m.obj = Objective(expr=   0.1*m.b37 + 0.2*m.b38 + 0.3*m.b39 + 0.4*m.b40 + 0.5*m.b41 + 0.6*m.b42 + m.i43 + m.i44 + m.i45
                        + m.i46 + m.i47 + m.i48, sense=minimize)
